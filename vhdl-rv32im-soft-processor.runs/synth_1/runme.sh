...
HD_PWD='F:/Google Drive/Personal Stuff/Programming/Vivado/vhdl-rv32im-soft-processor/vhdl-rv32im-soft-processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_trx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_trx.tcl
