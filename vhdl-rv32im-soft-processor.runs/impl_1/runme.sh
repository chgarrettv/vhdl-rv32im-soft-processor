...
HD_PWD='F:/Google Drive/Personal Stuff/Programming/Vivado/vhdl-rv32im-soft-processor/vhdl-rv32im-soft-processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_trx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_trx.tcl -notrace
